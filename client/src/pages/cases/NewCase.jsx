  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-primary-900">Register New Case</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
        ...
        {/* FIR Details */}
        <div>
          <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-4 pb-2 border-b">FIR Details</h2>
        ...
        {/* Incident Details */}
        <div>
          <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-4 pb-2 border-b">Incident Details</h2>
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-1">Incident Location <span className="text-red-500">*</span></label>
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button type="submit" disabled={isSubmitting}
            ...
            {isSubmitting ? 'Creating...' : 'Create Case & Continue'}
          </button>
        </div>
      </form>
    </div>
